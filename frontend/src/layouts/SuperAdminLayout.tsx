...
const SuperAdminLayout: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-950 text-gray-100 font-sans overflow-hidden">
      ...
      {isImpersonating && (
        <div className="bg-red-600 text-white text-center py-1 text-xs font-black uppercase tracking-widest shrink-0">
          ⚠️ Warning: You are currently active in an impersonated tenant session. Proceed with extreme caution.
        </div>
      )}
